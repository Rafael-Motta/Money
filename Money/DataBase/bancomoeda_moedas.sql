...
CREATE TABLE `moedas` (
  ...
  `valorR` decimal(11,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `moedas` VALUES (1,'Dolár','USD','$',3.20,NULL),(2,'Real','BRL','R$',4.50,NULL),(3,'Euro','EUR','€',10.11,NULL);
...
-- Dump completed on 2018-02-17  2:41:10
